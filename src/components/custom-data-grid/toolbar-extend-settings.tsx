...
export function CustomToolbarSettingsButton({
  ...
  const GRID_DENSITY_OPTIONS: {
    ...
    icon: React.ReactNode;
      ...
      { label: t('tableSettings.compactDensity'), value: 'compact', icon: <DensityCompactIcon /> },
      { label: t('tableSettings.standardDensity'), value: 'standard', icon: <DensityStandardIcon /> },
      {
        label: t('tableSettings.comfortableDensity'),
        value: 'comfortable',
  ...
  return (
    <>
      ...
      >
        ...
        {renderToggleOption(t('tableSettings.showColumnsBorders'), 'showColumnVerticalBorder')}
        {renderToggleOption(t('tableSettings.showCellsBorders'), 'showCellVerticalBorder')}
      </Menu>
    </>
  );
}
