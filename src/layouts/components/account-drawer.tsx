...
export function AccountDrawer({ data = [], sx, ...other }: AccountDrawerProps) {
  ...
  const renderAvatar = () => (
    ...
    >
      <Avatar src={user?.photoURL} alt={user?.names || user?.displayName} sx={{ width: 1, height: 1 }}>
  ...
  return (
    <>
      <AccountButton
        ...
        displayName={user?.names || user?.displayName || 'Usuario'}
        sx={sx}
        {...other}
      />
        ...
        <Scrollbar>
          ...
          >
            ...
            <Typography variant="subtitle1" noWrap sx={{ mt: 2 }}>
              {user?.names || user?.displayName || 'Usuario'}
            </Typography>
            ...
            {/* Mostrar roles del usuario si existen */}
