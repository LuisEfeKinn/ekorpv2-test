    ...
    <Stack spacing={{ xs: 2, sm: 3 }}>
      ...
      {route.objectives?.length > 0 && (
        <Card sx={{ p: { xs: 2, sm: 3 } }}>
          ...
          >
            <Iconify icon="solar:flag-bold" width={24} sx={{ mr: 1 }} />
            {t('ai-route-generation.preview.objectives')}
          </Typography>
          <Stack spacing={{ xs: 1.5, sm: 2 }}>
            {route.objectives.map((objective, index) => (
