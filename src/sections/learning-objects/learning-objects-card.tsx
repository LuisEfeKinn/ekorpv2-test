    ...
    >
      ...
      >
        ...
        <Chip
          label={
            row.isAIGenerated
              ? t('learning-objects.card.aiGenerated')
              : t('learning-objects.card.manual')
          }
          size="small"
          variant="filled"
          sx={{
            ...
            bgcolor: (theme) =>
              row.isAIGenerated
                ? alpha(theme.palette.info.main, 0.94)
                : alpha(theme.palette.warning.main, 0.94),
            color: (theme) =>
              row.isAIGenerated
            ...
            border: (theme) =>
              `1px solid ${
                row.isAIGenerated
                  ? alpha(theme.palette.info.dark, 0.45)
                  : alpha(theme.palette.warning.dark, 0.45)
              }`,
            boxShadow: (theme) =>
              row.isAIGenerated
                ? `0 6px 14px ${alpha(theme.palette.info.dark, 0.35)}`
                : `0 6px 14px ${alpha(theme.palette.warning.dark, 0.35)}`,
      ...
      >
        ...
        >
          {onView && (
            <Tooltip title={t('learning-objects.actions.viewDetails', 'Ver detalles')}>
              <IconButton
                color="primary"
                onClick={onView}
                sx={{
          ...
          {onEdit && (
            <Tooltip title={t('learning-objects.actions.edit', 'Editar')}>
              <IconButton
                color="default"
                onClick={onEdit}
                sx={{
          ...
          {onDelete && (
            <Tooltip title={t('learning-objects.actions.delete', 'Eliminar')}>
              <IconButton
                color="error"
                onClick={onDelete}
                sx={{
