  ...
  const renderBasicInfo = () => (
    <Card>
      <Stack spacing={3} sx={{ p: 3 }}>
        ...
        <Box>
          <Typography variant="subtitle2" sx={{ mb: 1.5 }}>
            {t('learning-objects.form.fields.imageUrl.label')}
          </Typography>
          <ImageUploader
            imageUrl={watch('imageUrl')}
            placeholderText={t('learning-objects.form.fields.imageUrl.placeholder')}
            // height={320}
            onUploadSuccess={(url) => {
        ...
        <Box>
          <Typography variant="subtitle2" sx={{ mb: 1.5 }}>
            {t('learning-objects.form.fields.bannerUrl.label')}
          </Typography>
          <ImageUploader
            imageUrl={watch('bannerUrl')}
            placeholderText={t('learning-objects.form.fields.bannerUrl.placeholder')}
            // height={200}
            onUploadSuccess={(url) => {
