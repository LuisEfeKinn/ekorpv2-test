...
import { LearningObjectDetailsCard } from "../learning-objects-details-card";

// ----------------------------------------------------------------------

export function LearningObjectsDetailsView() {
  ...
  if (error || !learningObject) {
    return (
      <Container maxWidth="xl">
        <CustomBreadcrumbs
          heading={t("learning-objects.details.user-title", "Detalles del Objeto de Aprendizaje")}
          links={[
            {
              name: t("learning-objects.title", "Objetos de Aprendizaje"),
              href: paths.dashboard.learning.learningObjects,
            },
            { name: t("learning-objects.details.user-title", "Detalles") },
          ]}
          sx={{ mb: { xs: 3, md: 5 } }}
        />
  ...
  return (
    <>
      ...
      <LearningObjectDetailsCard learningObject={learningObject} />
    </>
  )
}
