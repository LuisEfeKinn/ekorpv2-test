...
export function MyAssetsView() {
  ...
  const TABLE_HEAD: TableHeadCellProps[] = useMemo(
    () => [
      ...
      { id: 'assetNote', label: t('myAssets.table.columns.assetNote'), width: 200 },
      { id: 'purchaseDate', label: t('myAssets.table.columns.purchaseDate'), width: 140 },
      { id: 'purchaseValue', label: t('myAssets.table.columns.purchaseValue'), width: 140 },
      { id: 'deprecationDate', label: t('myAssets.table.columns.deprecationDate'), width: 150 },
      { id: 'warrantyExpiration', label: t('myAssets.table.columns.warrantyExpiration'), width: 160 },
