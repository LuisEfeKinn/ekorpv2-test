...
export function LearningPathTableFiltersResult({
  ...
  const handleRemoveIsAIGenerated = useCallback(() => {
    onResetPage();
    updateFilters({ isAIGenerated: '' });
  }, [onResetPage, updateFilters]);
  ...
  return (
    <FiltersResult totalResults={totalResults} onReset={handleReset} sx={sx}>
      ...
      <FiltersBlock label={t('learning-paths.table.filters.isAIGenerated.label')} isShow={!!currentFilters.isAIGenerated}>
        <Chip
          {...chipProps}
          label={currentFilters.isAIGenerated === 'true' ? t('learning-paths.table.filters.isAIGenerated.yes') : t('learning-paths.table.filters.isAIGenerated.no')}
          onDelete={handleRemoveIsAIGenerated}
        />
      </FiltersBlock>
    </FiltersResult>
  );
