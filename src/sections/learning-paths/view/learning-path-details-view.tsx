...
export function LearningPathDetailsView() {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      if (response.data.statusCode === 200) {
        ...
        // removed fictitious module progress generation
      } else {
        toast.error(
  ...
  return (
    <DashboardContent maxWidth="xl">
      <CustomBreadcrumbs
        heading={t("learning-paths.details.title")}
        links={[
          {
                      ...
                      <Box key={module.id} sx={{ position: "relative" }}>
                        ...
                        <AccordionDetails sx={{ px: { xs: 2, sm: 3 }, pb: { xs: 2, sm: 3 }, pt: { xs: 2, sm: 2.5 } }}>
                          <Stack spacing={2}>
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          <Button
                                            ...
                                            sx={{ flexShrink: 0 }}
                                            onClick={() => router.push(paths.dashboard.learning.learningObjectsDetails(course.id))}
                                          >
                                            {t("learning-paths.details.viewDetails")}
                                          </Button>
                                        </Stack>

                                        {/* Progress removed: not needed anymore */}
                                      </Stack>
                                    </Card>
                                  </Box>
                                )
                            ...
                            {/* Module progress removed: not needed anymore */}
                          </Stack>
                        </AccordionDetails>
                      </Accordion>
