    ...
    <Stack spacing={{ xs: 2, sm: 3 }}>
      ...
      <Card sx={{ p: { xs: 2, sm: 3 } }}>
        ...
        >
          <Chip
            ...
            label={t(`ai-course-generation.difficulty.${course.difficulty}`)}
            size="small"
            color={
          ...
          <Chip
            ...
            label={`${course.sections?.length || 0} ${t('ai-course-generation.sections')}`}
            size="small"
            variant="outlined"
          />
          <Chip
      ...
      <Card sx={{ p: { xs: 2, sm: 3 } }}>
        ...
        >
          ...
          />
          {t('ai-course-generation.preview.content')}
        </Typography>
        ...
        {course.sections?.length > 0 ? (
          ...
          <Alert severity="info">{t('ai-course-generation.preview.noContent')}</Alert>
        )}
      </Card>
    </Stack>
  );
      ...
      >
        ...
        <Stack spacing={{ xs: 2, sm: 2.5 }}>
          ...
          {(!section.blocks || section.blocks.length === 0) && (
            ...
            >
              {t('ai-course-generation.preview.noBlocks')}
            </Typography>
          )}
        </Stack>
      </AccordionDetails>
          ...
          <Card variant="outlined" sx={{ p: { xs: 1.5, sm: 2 } }}>
            ...
            >
              ...
              <Typography 
                ...
                sx={{ fontSize: { xs: '0.875rem', sm: '1rem' } }}
              >
                {t('ai-course-generation.preview.quiz')}
              </Typography>
            </Stack>
            <Typography 
              variant="body1" 
      ...
      default:
        return (
          <Typography variant="body2" color="text.secondary">
            {t('ai-course-generation.preview.unknownBlock')}: {block.type}
          </Typography>
        );
    }
  };
