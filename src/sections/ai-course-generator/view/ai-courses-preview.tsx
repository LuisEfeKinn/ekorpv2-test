...
export function AiCoursesPreviewView({ id }: Props) {
	...
	if (isLoading) {
		return (
			<DashboardContent>
				<CustomBreadcrumbs
					heading={t('ai-course-generation.preview.title')}
					links={[
						...
						{ name: t('ai-course-generation.preview.title') },
					]}
					sx={{ mb: { xs: 3, md: 5 } }}
				/>
	...
	return (
		<DashboardContent maxWidth="lg">
			<CustomBreadcrumbs
				heading={course?.title || t('ai-course-generation.preview.title')}
				links={[
					{ name: t('breadcrumbs.dashboard'), href: paths.dashboard.root },
					{ name: t('ai-course-generation.title'), href: paths.dashboard.ai.courseGenerator.root },
					{ name: course?.title || t('ai-course-generation.preview.title') },
				]}
				action={
					<Button
						variant="outlined"
					...
					>
						{t('ai-course-generation.actions.edit')}
					</Button>
				}
				sx={{ mb: { xs: 3, md: 5 } }}
			/>
