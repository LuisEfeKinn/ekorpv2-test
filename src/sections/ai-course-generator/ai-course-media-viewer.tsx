            ...
            >
              ...
              <Stack spacing={1} sx={{ flex: 1, p: { xs: 2, sm: 2 }, minWidth: 0 }}>
                ...
                {onClick && (
                  ...
                  >
                    {t('ai-course-generation.media.clickToExpand') || 'Haz clic para expandir'}
                  </Typography>
                )}
              </Stack>
            </Stack>
            ...
            >
              ...
              <Stack spacing={1} sx={{ flex: 1, p: { xs: 2, sm: 2 }, minWidth: 0 }}>
                ...
                >
                  ...
                  >
                    {t('ai-course-generation.media.clickToPlay') || 'Haz clic para reproducir'}
                  </Typography>
                </Stack>
              </Stack>
            </Stack>
          ...
          <Card variant="outlined" sx={{ p: 2 }}>
            ...
            <Box sx={{ mt: 2 }}>
              <audio controls style={{ width: '100%' }}>
                ...
                {t('ai-course-generation.media.audioNotSupported')}
              </audio>
            </Box>
          </Card>
        );
          ...
          <Card variant="outlined" sx={{ p: 2 }}>
            <Stack direction="row" spacing={2} alignItems="center">
              ...
              <Button
                ...
                download
              >
                {t('ai-course-generation.media.download')}
              </Button>
            </Stack>
          </Card>
        );
