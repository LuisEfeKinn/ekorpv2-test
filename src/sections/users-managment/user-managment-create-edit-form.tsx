...
export function UserManagementCreateEditForm({ currentUser }: Props) {
  ...
  const defaultAvatarUrl = currentUser?.avatar || currentUser?.avatarUrl || '';
  ...
  const renderAvatarInfo = () => (
    <Card sx={{ p: 3, height: 1 }}>
      <Typography variant="h6" sx={{ mb: 2.5 }}>
        {tUsers('user-management.form.fields.avatar.label')}
      </Typography>
      ...
      <Stack spacing={2.5} alignItems="center">
        <Box sx={{ width: '100%', maxWidth: 320, mx: 'auto' }}>
          <ImageUploader
            ...
            placeholderText={tUsers('user-management.form.fields.avatar.placeholder')}
            height={280}
            maxSize={3145728}
        ...
        <Typography variant="caption" sx={{ color: 'text.secondary', textAlign: 'center' }}>
          {tUsers('user-management.form.fields.avatar.helperText')}
        </Typography>
      </Stack>
    </Card>
  );
      ...
      <Grid container spacing={3}>
        <Grid size={{ xs: 12, md: 6 }}>
          <CountryAutocompleteSimple
            name="countrySelect"
            label={tUsers('user-management.form.fields.countryId.label')}
            placeholder={tUsers('user-management.form.fields.countryId.placeholder')}
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <RegionAutocompleteStandalone
            name="regionSelect"
            label={tUsers('user-management.form.fields.regionId.label')}
            placeholder={tUsers('user-management.form.fields.regionId.placeholder')}
        ...
        <Grid size={{ xs: 12, md: 6 }}>
          <MunicipalityAutocompleteStandalone
            ...
            placeholder={tUsers('user-management.form.fields.municipalityId.placeholder')}
      ...
      <Grid container spacing={3}>
        <Grid size={{ xs: 12, md: 6 }}>
          <PositionAutocomplete
            ...
            placeholder={tUsers('user-management.form.fields.positionId.placeholder')}
