...
export function EvaluationsListTableFiltersResult({
  ...
  return (
    <FiltersResult totalResults={totalResults} onReset={handleReset} sx={sx}>
      <FiltersBlock
        label={`${t('nine-box.table.filters.keyword')}:`}
      ...
      <FiltersBlock
        label={`${t('nine-box.table.filters.type')}:`}
      ...
      <FiltersBlock
        label={`${t('nine-box.table.filters.status')}:`}
      ...
      <FiltersBlock
        label={`${t('nine-box.table.filters.department')}:`}
      ...
      <FiltersBlock
        label={`${t('nine-box.table.filters.position')}:`}
      ...
      <FiltersBlock
        label={`${t('nine-box.table.filters.employee')}:`}
