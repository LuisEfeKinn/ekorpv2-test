...
export function EvaluationsListTableToolbar({ filters, onResetPage }: Props) {
  ...
  const translateType = useCallback(
    (typeId: string) => t(`nine-box.types.${typeId}`),
    [t]
  );

  const translateStatus = useCallback(
    (statusId: string) => t(`nine-box.statuses.${statusId}`),
    [t]
  );
  ...
  return (
    <Stack spacing={2} sx={{ p: 2.5 }}>
      ...
      <TextField
        ...
        placeholder={t('nine-box.table.toolbar.search')}
        InputProps={{
          startAdornment: (
      ...
      >
        ...
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField
              {...params}
              placeholder={t('nine-box.table.toolbar.filterByType')}
              InputProps={{
                ...params.InputProps,
                startAdornment: (
                  <InputAdornment position="start">
        ...
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField
              {...params}
              placeholder={t('nine-box.table.toolbar.filterByStatus')}
              InputProps={{
                ...params.InputProps,
                startAdornment: (
                  <InputAdornment position="start">
        ...
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField
              {...params}
              placeholder={t('nine-box.table.toolbar.filterByDepartment')}
              InputProps={{
                ...params.InputProps,
                startAdornment: (
                  <InputAdornment position="start">
        ...
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField
              {...params}
              placeholder={t('nine-box.table.toolbar.filterByPosition')}
              InputProps={{
                ...params.InputProps,
                startAdornment: (
                  <InputAdornment position="start">
        ...
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField
              {...params}
              placeholder={t('nine-box.table.toolbar.filterByEmployee')}
              InputProps={{
                ...params.InputProps,
                startAdornment: (
                  <InputAdornment position="start">
