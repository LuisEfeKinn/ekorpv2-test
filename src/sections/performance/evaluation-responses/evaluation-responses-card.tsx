...
export function EvaluationResponsesCard({ row }: Props) {
  ...
  const relationshipColors: { [key: string]: 'primary' | 'secondary' | 'info' | 'success' | 'warning' | 'error' | 'default' } = {
    SELF: 'info',
    PEER: 'secondary',
    MANAGER: 'warning',
    SUBORDINATE: 'success',
      ...
      >
        ...
        <Stack direction="row" alignItems="flex-start" spacing={2} sx={{ mb: 2 }}>
          ...
          <Stack spacing={0.5} sx={{ flex: 1, minWidth: 0 }}>
            ...
            <Label variant="soft" color={relationshipColors[row.relationship] ?? 'default'} sx={{ width: 'fit-content' }}>
