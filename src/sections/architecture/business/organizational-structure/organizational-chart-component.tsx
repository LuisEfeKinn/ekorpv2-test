...
export function OrganizationalChartComponent({ initialNodeId, fetchNodeData, onNodeClick, sx }: Props) {
  ...
  }, [currentNodeId, fetchNodeData, buildGraph, t]);
  ...
  return (
    <Box sx={{ width: '100%', height: '80vh', position: 'relative', ...sx }}>
      ...
      {parentNode && (
        ...
        >
          <Button
            ...
            color="inherit"
          >
            {t('organization.map.backTo', { label: parentNode.label })}
          </Button>
        </Box>
      )}
      ...
      <ReactFlow
        ...
        fitView
        fitViewOptions={{ padding: 0.1, minZoom: 0.3, maxZoom: 0.3 }}
