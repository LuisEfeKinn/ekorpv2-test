...
import { SaveStrategicObjectiveFeedbackService } from 'src/services/architecture/business/strategic-objectives-feedbacks.service';
...
export function StrategicObjectivesLessonsProposalsDrawer({ open, onClose, onSuccess, objectiveId, isLessonLearned }: Props) {
