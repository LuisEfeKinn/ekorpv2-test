    ...
    <Box sx={{ p: 3 }}>
      ...
      <Form methods={methods} onSubmit={onSubmit}>
        <Stack spacing={3}>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 2 }}>
            <Field.DatePicker name="startDate" label="Fecha de Redacción" minDate={dayjs()} />
            <Field.DatePicker name="endDate" label="Fecha de Expiración" minDate={watchStartDate ? dayjs(watchStartDate) : dayjs()} />
          </Box>
