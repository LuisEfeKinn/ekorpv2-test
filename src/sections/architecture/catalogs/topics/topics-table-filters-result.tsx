...
export function TopicsTableFiltersResult({ filters, onFilters, onReset, totalResults, sx }: Props) {
  ...
  return (
    <FiltersResult totalResults={totalResults} onReset={onReset} sx={sx}>
      <FiltersBlock label={`${t('topics.filters.keyword')}:`} isShow={!!filters.name}>
