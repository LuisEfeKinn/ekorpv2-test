...
export function InfrastructureDiagramFlowCreateModal({ open, onClose, parentNodeId, onSave, ...other }: Props) {
  ...
  const handleSave = async () => {
    if (!isFormValid()) {
      toast.error(t('infrastructure.diagram.messages.error.validation'));
      return;
    }
    ...
    try {
      ...
      toast.error(t('infrastructure.diagram.messages.error.creating'));
    } finally {
      setSaving(false);
    }
  };
        ...
        <Stack direction="row" spacing={2} alignItems="center">
          <Box sx={{ flex: 1 }}>
            <Typography variant="h5" sx={{ color: 'common.white', fontWeight: 700, mb: 0.5 }}>
              {t('infrastructure.diagram.dialogs.create.title')}
            </Typography>
          </Box>
        </Stack>
      </Box>
        ...
        <Stack spacing={0}>
          ...
          >
            ...
            <Stack spacing={2.5}>
              <TextField
                fullWidth
                label={t('infrastructure.diagram.dialogs.form.name.label')}
                value={formData.name}
              ...
              <TextField
                fullWidth
                label={t('infrastructure.diagram.dialogs.form.description.label')}
          ...
          >
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr 1fr' }, gap: 2 }}>
              ...
              <TextField
                fullWidth
                label={t('infrastructure.diagram.dialogs.form.code.label')}
                value={formData.code}
