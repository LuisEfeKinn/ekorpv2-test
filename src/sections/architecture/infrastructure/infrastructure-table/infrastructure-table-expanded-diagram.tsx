...
export function InfrastructureTableExpandedDiagram({
  ...
  const handleDeleteNode = async () => {
    ...
    try {
      setDeleting(true);
      await DeleteInfraestructureTableMapNodeService(infraestructureId, deleteDialog.nodeId);
      ...
      >
        <Stack alignItems="center" spacing={2}>
          ...
          <Typography variant="body2" color="text.secondary">
            {t('infrastructure.map.diagram.loadingMap')}
          </Typography>
        </Stack>
      </Box>
    );
    ...
    return (
      ...
      >
        <Typography variant="body1" color="text.secondary">
          {t('infrastructure.map.diagram.noData')}
        </Typography>
      </Box>
    );
  }
  ...
  if (mapData.children.length === 0) {
    return (
      ...
      >
        ...
        >
          <Stack alignItems="center" spacing={3}>
            ...
            <Stack spacing={1} alignItems="center">
              ...
              <Typography variant="body2" color="text.secondary">
                {t('infrastructure.map.diagram.subDiagram.noRelations')}
              </Typography>
            </Stack>
          </Stack>
        </Box>
        ...
        {/* Modal de creación */}
        <InfrastructureTableNodeCreateModal
          open={openCreateModal}
          onClose={() => setOpenCreateModal(false)}
          onSuccess={fetchExpandedData}
          infraestructureId={infraestructureId}
          parentNodeId={nodeId}
        />
      </Card>
    );
  ...
  return (
    ...
    >
          ...
          <Stack direction="row" spacing={1} alignItems="center">
            ...
            <Stack direction="row" spacing={0.5} alignItems="center">
              <Typography variant="caption" sx={{ fontWeight: 600, color: 'text.secondary' }}>
                {t('infrastructure.map.diagram.subDiagram.home')}
              </Typography>
              <Iconify
        ...
        >
          ...
          >
            <Stack direction="row" spacing={1} alignItems="center">
              ...
              >
                {mapData.children.length} {t('infrastructure.map.diagram.conectedModules')}
              </Typography>
            </Stack>
          </Paper>
        </Box>
          ...
          >
            <Stack spacing={0.75}>
              <Stack direction="row" spacing={1} alignItems="center">
                ...
                >
                  {t('infrastructure.map.diagram.controls.zoom')}
                </Typography>
              </Stack>
              <Stack direction="row" spacing={1} alignItems="center">
                <Box
                ...
                >
                  {t('infrastructure.map.diagram.controls.move')}
                </Typography>
              </Stack>
            </Stack>
          </Paper>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>{t('infrastructure.table.dialogs.delete.content')}</DialogContentText>
        </DialogContent>
        <DialogActions sx={{ px: 3, pb: 3 }}>
          ...
          >
            {t('infrastructure.table.dialogs.delete.confirm')}
          </Button>
        </DialogActions>
      </Dialog>
    </Card>
