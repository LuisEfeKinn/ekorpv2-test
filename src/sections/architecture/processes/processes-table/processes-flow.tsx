...
export function ProcessesFlow({ sx, data, onEditProcess, onNodeDoubleClick, reloadKey, onBack, parentLabel }: ProcessesFlowProps) {
  const { t } = useTranslate('architecture');
  const theme = useTheme();
  ...
  const generateNodesAndEdges = useCallback(() => {
    ...
    setEdges(newEdges);
  }, [rootProcesses, expandedNodes, colors, handleExpandNode, handleEditNode, applyDagreLayout, setNodes, setEdges, onNodeDoubleClick]);
