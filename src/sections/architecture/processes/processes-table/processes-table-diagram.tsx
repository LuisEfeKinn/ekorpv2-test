  ...
  return (
    ...
    >
      ...
      <Stack spacing={1.5} alignItems="center">
        <Chip label={`ID: ${data.appId}`} size="small" sx={{ bgcolor: alpha(theme.palette.common.white, 0.25), color: 'common.white', fontWeight: 700, fontSize: '0.75rem', height: 24, backdropFilter: 'blur(10px)' }} />
