...
import { GetIndicatorsListService, SaveProcessIndicatorService } from 'src/services/architecture/process/processRelations.service';
...
export function ProcessIndicatorLinkModal({ open, onClose, onSuccess, processId }: Props) {
