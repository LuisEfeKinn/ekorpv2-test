...
export function ProcessToolLinkModal({ open, onClose, onSuccess, processId, relationId, initialData, allowDelete }: Props) {
      ...
      <Box sx={{ px: 2, py: 2 }}>
        ...
        <Stack spacing={2} sx={{ pt: 1 }}>
          <Autocomplete
            ...
            renderInput={(params: any) => <TextField {...params} label={t('process.map.modals.tool.fieldLabel')} />}
          />
          <TextField 
