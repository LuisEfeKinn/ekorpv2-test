...
import { SaveProcessToolService } from 'src/services/architecture/process/processRelations.service';
...
export function ProcessToolLinkModal({ open, onClose, onSuccess, processId }: Props) {
