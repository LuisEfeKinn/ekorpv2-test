...
export function ApplicationDiagramFlowCreateModal({ open, onClose, parentNodeId, onSave, ...other }: Props) {
  ...
  const handleSave = async () => {
    if (!isFormValid()) {
      toast.error(t('application.diagram.messages.error.validation'));
      return;
    }
        ...
        <Stack spacing={0}>
          ...
          >
            ...
            <Stack spacing={2.5}>
              <TextField
                fullWidth
                label={t('application.diagram.dialogs.form.name.label')}
                value={formData.name}
              ...
              <TextField
                fullWidth
                label={t('application.diagram.dialogs.form.description.label')}
          ...
          >
            ...
            <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr 1fr' }, gap: 2 }}>
              ...
              <TextField
                fullWidth
                label={t('application.diagram.dialogs.form.code.label')}
                value={formData.code}
