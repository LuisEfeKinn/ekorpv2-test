...
export function ApplicationDiagramFlowEditModal({ open, onClose, dataId, onSave, ...other }: Props) {
  const { t } = useTranslate('architecture');
  const theme = useTheme();
  const titleId = 'application-flow-edit-title';
  ...
  const loadData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await GetApplicationTableByIdService(dataId);
      if (response?.data) {
    ...
    >
      <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
        ...
        >
          <Stack direction="row" spacing={2} alignItems="center">
            <Box sx={{ flex: 1, minWidth: 0 }}>
              ...
              >
                {dataId ? t('application.table.dialogs.edit.title') : t('application.table.dialogs.create.title')}
              </Typography>
            </Box>
          ...
          <Stack spacing={0}>
            ...
            >
              <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2.5 }}>
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 600, color: 'text.primary' }}>
                  {t('application.diagram.dialogs.sectionsLabels.basicInfo')}
                </Typography>
              </Stack>
            ...
            <Paper elevation={0} sx={{ p: 3, borderRadius: 0 }}>
              <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2.5 }}>
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 600, color: 'text.primary' }}>
                  {t('application.diagram.dialogs.sectionsLabels.settings')}
                </Typography>
              </Stack>
            ...
            >
              <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2.5 }}>
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 600, color: 'text.primary' }}>
                  {t('application.diagram.dialogs.sectionsLabels.identification')}
                </Typography>
              </Stack>
            ...
            <Paper elevation={0} sx={{ p: 3, borderRadius: 0, bgcolor: alpha(theme.palette.warning.main, 0.02) }}>
              <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2.5 }}>
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 600, color: 'text.primary' }}>
                  {t('application.diagram.dialogs.sectionsLabels.dataType')}
                </Typography>
              </Stack>
            ...
            <Paper elevation={0} sx={{ p: 3, borderRadius: 0 }}>
              <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2.5 }}>
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 600, color: 'text.primary' }}>
                  {t('application.diagram.dialogs.sectionsLabels.provider')}
                </Typography>
              </Stack>
            ...
            <Paper elevation={0} sx={{ p: 3, borderRadius: 0, bgcolor: alpha(theme.palette.info.main, 0.02) }}>
              <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2.5 }}>
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 600, color: 'text.primary' }}>
                  {t('application.diagram.dialogs.sectionsLabels.domain')}
                </Typography>
              </Stack>
            ...
            <Paper elevation={0} sx={{ p: 3, borderRadius: 0 }}>
              <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2.5 }}>
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 600, color: 'text.primary' }}>
                  {t('application.diagram.dialogs.sectionsLabels.datesAndContracts')}
                </Typography>
              </Stack>
            ...
            <Paper elevation={0} sx={{ p: 3, borderRadius: 0, bgcolor: alpha(theme.palette.primary.main, 0.02) }}>
              <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 2.5 }}>
                ...
                <Typography variant="subtitle1" sx={{ fontWeight: 600, color: 'text.primary' }}>
                  {t('application.diagram.dialogs.sectionsLabels.slaAndImpact')}
                </Typography>
              </Stack>
              ...
              <Stack spacing={2.5}>
                <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', sm: '1fr 1fr' }, gap: 2 }}>
                  <FormControlLabel
                    ...
                    label={t('application.diagram.dialogs.form.requiresSla.label')}
                  />
                  ...
                  <FormControlLabel
                    ...
                    label={t('application.diagram.dialogs.form.hasSla.label')}
                  />
                </Box>
        ...
        >
          ...
          >
            {dataId ? t('application.table.actions.update') : t('application.table.actions.save')}
          </LoadingButton>
        </Box>
      </Box>
    </Drawer>
