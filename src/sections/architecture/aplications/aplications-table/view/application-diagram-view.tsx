...
import { ApplicationDiagramFlow } from '../application-diagram-flow';

// ----------------------------------------------------------------------

type ApplicationDiagramViewProps = {
  sx?: SxProps<Theme>;
};

// ----------------------------------------------------------------------

export function ApplicationDiagramView({ sx }: ApplicationDiagramViewProps) {
  ...
  return (
    <Container maxWidth="xl">
      <Stack spacing={3}>
        ...
        <CustomBreadcrumbs
          heading={t('application.diagram.title')}
          links={[
            {
              name: t('application.table.breadcrumbs.dashboard'),
              href: paths.dashboard.root,
            },
            {
              name: t('application.diagram.title'),
            },
          ]}
          action={
            <Stack direction="row" spacing={2} alignItems="center">
              ...
              <Button
                href={paths.dashboard.architecture.applicationsTable}
                variant="contained"
                startIcon={<Iconify icon="solar:eye-bold" />}
              >
                {t('application.diagram.actions.viewTable')}
              </Button>
              <Button
                href={paths.dashboard.architecture.applicationsTimeline}
                variant="contained"
                startIcon={<Iconify icon="solar:eye-bold" />}
              >
                {t('application.diagram.actions.viewTimeline')}
              </Button>
            </Stack>
          }
          sx={{
