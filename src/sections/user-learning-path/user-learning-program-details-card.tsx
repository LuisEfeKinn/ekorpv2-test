...
export function UserLearningProgramDetailsCard({ learningObject, progress = 0 }: Props) {
                ...
                <Grid container spacing={2}>
                  {learningObject.courses
                    ...
                    .map((course) => {
                      ...
                      const courseImageUrl = isValidImageUrl(course.imageUrl)
                        ? course.imageUrl
                        : isValidImageUrl(course.bannerUrl)
                          ? course.bannerUrl
                          : null;
                      const isEkorp = course.isEkorp === true || course.isEkorp === "true";
