      ...
      <Grid container spacing={4} sx={{ mb: 5 }}>
        <Grid size={{ xs: 12, md: 7 }}>
          <Stack spacing={3}>
            ...
            {/* Mostrar job o position según disponibilidad */}
            {((learningPath as any).job || learningPath.position) && (
              <Box
                sx={{
                  p: 2.5,
                  borderRadius: 2,
                ...
                <Stack direction="row" alignItems="center" spacing={1.5}>
                  ...
                  <Box>
                    <Typography variant="subtitle1" sx={{ color: "info.dark", fontWeight: 700 }}>
                      {(learningPath as any).job?.name || learningPath.position?.name}
                      {((learningPath as any).job?.code || learningPath.position?.abbreviation) && (
                        <Box component="span" sx={{ ml: 1, color: "text.secondary", fontWeight: 500 }}>
                          ({(learningPath as any).job?.code || learningPath.position?.abbreviation})
                        </Box>
                      )}
                    </Typography>
                    {((learningPath as any).job?.objectives || learningPath.position?.description) && (
              ...
              <Stack spacing={0}>
                {learningPath.modules
                  ...
                  .map((module, index) => {
                    ...
                    // Nueva API usa competency en lugar de skill
                    const moduleName =
                      (module as any).competency?.name ||
                      module.skill?.name ||
                          ...
                          <Stack direction="row" alignItems="center" spacing={{ xs: 1.5, sm: 2 }} sx={{ width: "100%", pr: 1, pl: { xs: 1, sm: 1.5 } }}>
                            ...
                            <Box sx={{ flex: 1, minWidth: 0 }}>
                              <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 0.5 }}>
                                ...
                                {/* Mostrar skillLevel si existe (nueva o antigua API) */}
                                {module.skillLevel && (
                                  <Label
                                    sx={{
                                      ...
                                      >
                                        ...
                                        >
                                          ...
                                          <Button
                                            ...
                                            sx={{ flexShrink: 0 }}
                                            onClick={() => router.push(paths.dashboard.userLearning.myLearningPathProgramDetails(id as any, course.id))}
                                          >
