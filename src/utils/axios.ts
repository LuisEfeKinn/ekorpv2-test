...
export const endpoints = {
  ai: {
    ...
    routeGenerator: {
      all: '/ai-learning-paths',
      save: '/ai-learning-paths',
      update: '/ai-learning-paths',
      edit: '/ai-learning-paths', // + /:id
      delete: '/ai-learning-paths', // + /:id
    }
  },
  file: {
  ...
  employees: {
    ...
    skills: {
        all: '/competency-km',
        save: '/competency-km',
        update: '/competency-km',
        edit: '/competency-km', // + /:id
        delete: '/competency-km', // + /:id
        type: '/type-competency-km'
    },
    enrollments: {
      all: '/employees/course/employee-enrollments'
    },
    paymentPeriods:{
      all: '/employees/payments-periods'
    }
  },
  organization: {
    company: {
    ...
    organizationalUnits: {
      ...
      pagination: '/organizational-unit',
      ...
      feedbacks: '/api/feedbacks/organizational-unit' // + /:id
    },
    organigram: {
      jobs: '/api/jobs/tree',
  ...
  learning: {
    courses: {
      ...
      learningUnitsByEnrollment: '/learning-units/enrollment', // + /:enrollmentId
      finishedActivities: '/enrollments/activity-complete',
      singleSignOn: '/employees/course/single-sign-on' // + /:enrollmentId
    },
    learningObjects: {
  ...
  performance: {
    ...
    configureTests: {
      ...
      duplicate: '/performance-management/templates' // + /:id/duplicate
    },
    ...
    configureEvaluations: {
      ...
      launch: '/performance-management/evaluation-campaigns', // + /:id/launch
      cancel: '/performance-management/evaluation-campaigns', // + /:id/cancel
      participants: {
  ...
  projectManagement: {
    clients: {
      all: '/project-management/clients',
      save: '/project-management/clients',
      update: '/project-management/clients', // + /:id
      edit: '/project-management/clients',   // + /:id
      delete: '/project-management/clients', // + /:id
    },
    workers: {
    ...
    projects: {
      ...
      save: '/project-management/projects',
      update: '/project-management/projects', // + /:id
    ...
    catalogs: {
      ...
      projectImportanceLevels: '/project-management/catalogs/project-importance-levels',
      projectSizes: '/project-management/catalogs/project-sizes',
      projectComplexities: '/project-management/catalogs/project-complexities',
      projectReintegroLevels: '/project-management/catalogs/project-reintegro-levels',
      projectStatuses: '/project-management/catalogs/project-statuses',
      assignmentPriorities: '/project-management/catalogs/assignment-priorities',
  ...
  architecture: {
    relatedData: {
      ...
      objectives: {
        ...
        feedbacks: '/api/feedbacks/objective' // + /:id
      },
      competencies: {
    ...
    tools: {
      table: {
        ...
        edit: '/api/tools', // + /:id
        delete: '/api/tools', // + /:id
        feedbacks: '/api/feedbacks/tool' // + /:id
      },
      relations: {
        documents: '/api/tool-documents',
        indicators: '/api/tool-indicators'
      },
      map: {
    ...
    catalogs: {
      ...
      timeUnits: {
        all: '/api/time-units',
        save: '/api/time-units',
        update: '/api/time-units',
        edit: '/api/time-units', // + /:id
        delete: '/api/time-units' // + /:id
      },
      domains: {
        all: '/api/domains',
        save: '/api/domains',
