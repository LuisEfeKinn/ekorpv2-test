...
export const paths = {
  ...
  dashboard: {
    ...
    employees: {
      ...
      // Competencies
      skills: `${ROOTS.DASHBOARD}/employees/competencies`,
      skillsEdit: (id: string) => `${ROOTS.DASHBOARD}/employees/competencies/edit/${id}`,
      skillsCreate: `${ROOTS.DASHBOARD}/employees/competencies/create`,
    },
    ...
    learning: {
      ...
      aiLearningObjects: `${ROOTS.DASHBOARD}/learning/objects/ai`,
      ...
      aiLearningPaths: `${ROOTS.DASHBOARD}/learning/paths/ai`,
      allAiLearningPaths: `${ROOTS.DASHBOARD}/learning/paths/all-with-ai`,
    ...
    userLearning: {
      ...
      myLearningPathProgramDetails: (id: string, idP: string) => `${ROOTS.DASHBOARD}/corporate-university/learning-path/${id}/program-details/${idP}`,
    ...
    performance: {
      ...
      campaignAnalysis: (id: string) => `${ROOTS.DASHBOARD}/performance/configure-evaluations/analysis/${id}`,
    ...
    architecture: {
      ...
      organizationalStructureTableEdit: (id: string) =>
        `${ROOTS.DASHBOARD}/architecture/business/organizational-structure/table/edit/${id}`,
      // Map
    ...
    ai: {
      ...
      routeGenerator: {
        root: `${ROOTS.DASHBOARD}/ai/route-generator`,
        create: `${ROOTS.DASHBOARD}/ai/route-generator/create`,
        edit: (id: string) => `${ROOTS.DASHBOARD}/ai/route-generator/edit/${id}`,
        view: (id: string) => `${ROOTS.DASHBOARD}/ai/route-generator/view/${id}`
      },
      programGenerator: {
        root: `${ROOTS.DASHBOARD}/ai/program-generator`,
        create: `${ROOTS.DASHBOARD}/ai/program-generator/create`,
        edit: (id: string) => `${ROOTS.DASHBOARD}/ai/program-generator/edit/${id}`,
        view: (id: string) => `${ROOTS.DASHBOARD}/ai/program-generator/view/${id}`
      },
      providerSettings: {
