...
9. **CRITICAL JSON FORMATTING** (output MUST be parseable by JSON.parse):
   ...
   - The JSON object MUST start on the line immediately after the opening \`\`\`json — do NOT add any descriptive text inside the code block before or after the JSON object
