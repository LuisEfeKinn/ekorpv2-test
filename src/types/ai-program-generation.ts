...
- ALL course IDs must use the "lmsCourseId" field from the catalog.
...
- The "courses" array contains objects with "courseLmsId" (string from catalog) and "order" (number).
