...
export const GetJobDocumentRelationByIdService = async (id: number | string) => {
  const response = await axios.get(`${endpoints.architecture.business.jobRelations.jobDocuments}/${id}`);
  return response;
};

export const UpdateJobDocumentRelationService = async (
  id: number | string,
  data: SaveJobDocumentRelationPayload
) => {
  const response = await axios.patch(
    `${endpoints.architecture.business.jobRelations.jobDocuments}/${id}`,
    data
  );
  return response;
};

export const DeleteJobDocumentRelationService = async (id: number | string) => {
...
export const GetJobSystemRelationByIdService = async (id: number | string) => {
  const response = await axios.get(`${endpoints.architecture.business.jobRelations.jobSystems}/${id}`);
  return response;
};

export const UpdateJobSystemRelationService = async (
  id: number | string,
  data: SaveJobSystemRelationPayload
) => {
  const response = await axios.patch(
    `${endpoints.architecture.business.jobRelations.jobSystems}/${id}`,
    data
  );
  return response;
};

export const DeleteJobSystemRelationService = async (id: number | string) => {
  const response = await axios.delete(
    `${endpoints.architecture.business.jobRelations.jobSystems}/${id}`
  );
  return response;
...
export const GetJobIndicatorRelationByIdService = async (id: number | string) => {
  const response = await axios.get(`${endpoints.architecture.business.jobRelations.jobIndicators}/${id}`);
  return response;
};

export const UpdateJobIndicatorRelationService = async (
  id: number | string,
  data: SaveJobIndicatorRelationPayload
) => {
  const response = await axios.patch(
    `${endpoints.architecture.business.jobRelations.jobIndicators}/${id}`,
    data
  );
  return response;
};

export const DeleteJobIndicatorRelationService = async (id: number | string) => {
  const response = await axios.delete(
    `${endpoints.architecture.business.jobRelations.jobIndicators}/${id}`
  );
  return response;
...
export const GetJobDataRelationByIdService = async (id: number | string) => {
  const response = await axios.get(`${endpoints.architecture.business.jobRelations.jobData}/${id}`);
  return response;
};

export const UpdateJobDataRelationService = async (
  id: number | string,
  data: SaveJobDataPayload
) => {
  const response = await axios.patch(
    `${endpoints.architecture.business.jobRelations.jobData}/${id}`,
    data
  );
  return response;
};

export const DeleteJobDataRelationService = async (id: number | string) => {
  const response = await axios.delete(
    `${endpoints.architecture.business.jobRelations.jobData}/${id}`
  );
  return response;
...
export const GetJobTechnologiesRelationByIdService = async (id: number | string) => {
  const response = await axios.get(`${endpoints.architecture.business.jobRelations.jobTechnologies}/${id}`);
  return response;
};

export const UpdateJobTechnologiesRelationService = async (
  id: number | string,
  data: SaveJobTechnologiesPayload
) => {
  const response = await axios.patch(
    `${endpoints.architecture.business.jobRelations.jobTechnologies}/${id}`,
    data
  );
  return response;
};

export const DeleteJobTechnologiesRelationService = async (id: number | string) => {
  const response = await axios.delete(
    `${endpoints.architecture.business.jobRelations.jobTechnologies}/${id}`
  );
  return response;
...
export const GetJobRelationTypeByIdService = async (id: number | string) => {
  const response = await axios.get(`/api/job-relation-types/${id}`);
  return response;
};

export const DeleteJobRelationTypeService = async (id: number | string) => {
  const response = await axios.delete(`/api/job-relation-types/${id}`);
  return response;
};

export const GetNextJobByIdService = async (id: number | string) => {
  const response = await axios.get(`/api/next-jobs/${id}`);
  return response;
};

export const DeleteNextJobService = async (id: number | string) => {
  const response = await axios.delete(`/api/next-jobs/${id}`);
  return response;
};
