...
export const GetLearningPathsByUserManagementIdService = async (data?: any) => {
  const response = await axios.get(`${endpoints.employees.userManagment.learningPaths.all}`, { params: data });
  return response;
};
